        ...
        >
          ...
          <div className="max-w-3xl mx-auto text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a href="#contact-widget" className="inline-flex justify-center items-center gap-2 px-8 py-4 rounded-full bg-white text-black font-semibold hover:bg-gray-200 transition-colors shadow-[0_0_20px_rgba(255,255,255,0.2)] hover:shadow-[0_0_30px_rgba(255,255,255,0.4)]">
                Contact details <ArrowRight className="w-5 h-5" />
              </a>
              <a href="mailto:e.meephu@gmail.com" className="inline-flex justify-center items-center gap-2 px-8 py-4 rounded-full bg-white/5 border border-white/10 text-white font-medium hover:bg-white/10 transition-colors">
                Email Marcuz
              </a>
            </div>
          </div>
